    ...
    CONTAINER.createRectangleGroup({
        ...
        create=function(input)
            ...
            TEXT.drawText({
                ...
                width=input.width,
                height=input.height,
                text='Are you sure you want to delete current save data?'
            })
    ...
    COMMON.createRectangleWithText({
        ...
        touch=function()
            ...
            MAIN.UTILITY.sceneFadeOut({
                onComplete=function()
                    MAIN.SYSTEM.SAVE.deleteSave()
                    MAIN.SYSTEM.TIME.stopTime()

                    --Need to clear these things
                    MAIN.PLAYER.MEMBERS.clearMembers()
                    MAIN.PLAYER.INVENTORY.clearInventory()

                    MAIN.UTILITY.gotoScene('scene.title.title')
